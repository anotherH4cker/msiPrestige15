...
then
	...
	sudo python3 /opt/msiprestige15/fan/control.py /opt/msiprestige15/fan/quiet.ini &
	MODE=0
	echo "0" > /tmp/mode.txt
...
then
	...
	sudo python3 /opt/msiprestige15/fan/control.py /opt/msiprestige15/fan/loud.ini &
	MODE=2
	echo "2" > /tmp/mode.txt
...
then
	...
	sudo python3 /opt/msiprestige15/fan/control.py /opt/msiprestige15/fan/normal.ini &
	MODE=1
	echo "1" > /tmp/mode.txt
